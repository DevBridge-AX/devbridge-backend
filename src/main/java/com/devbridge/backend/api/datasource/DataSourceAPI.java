...
public interface DataSourceAPI {
    ...
    @Operation(summary = "데이터 소스 목록 조회", description = "워크스페이스에 연동된 데이터 소스 목록을 조회합니다.")
    @GetMapping
    ResponseEntity<List<DataSourceResponse>> getDataSources(@RequestParam("workspaceId") String workspaceId);
